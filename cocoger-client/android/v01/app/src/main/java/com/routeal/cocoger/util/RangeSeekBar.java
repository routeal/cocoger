...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#FF4081");
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultShadowYOffset = dpToPx(context, 2);
        int defaultShadowXOffset = dpToPx(context, 0);
        int defaultShadowBlur = dpToPx(context, 2);


        if (attrs == null) {
            setRangeToDefaultValues();
            mInternalPad = dpToPx(context, INITIAL_PADDING_IN_DP);
            barHeight = dpToPx(context, LINE_HEIGHT_IN_DP);
        ...
        mTextOffset = !mShowTextAboveThumbs ? 0 : this.mTextSize + dpToPx(context,
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = thumbImage.getHeight()
                + (!mShowTextAboveThumbs ? 0 : dpToPx(getContext(), HEIGHT_IN_DP))
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        padding = mInternalPad + minMaxLabelSize + mThumbHalfWidth + 16;
        ...
        if (mShowTextAboveThumbs && !selectedValuesAreDefault) {
            ...
            String minText = String.valueOf(getSelectedMinTime());
            String maxText = String.valueOf(getSelectedMaxTime());

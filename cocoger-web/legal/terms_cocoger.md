# **COCOGER** TERMS OF SERVICE

Last Updated: **12/1/2015**

These terms of service ("Terms") apply to your access and use of **COCOGER** (the "Service"). Please read them carefully.

## Accepting these Terms

If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing **support@routeal.com**.

## Changes to these Terms

We reserve the right to modify these Terms at any time. For instance, we may need to change these Terms if we come out with a new feature or for some other reason.

Whenever we make changes to these Terms, the changes are effective **immediately** after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check **COCOGER** for changes to these Terms.

If you continue to use the Service after the revised Terms go into effect, then you have accepted the changes to these Terms.

## Privacy Policy

For information about how we collect and use information about users of the Service, please check out our privacy policy available at **http://cocoger.com/privacy.html**.
...
The Service enables you to share location information among other users. Your personal information (name and icon image) registered in the Service will be viewable to other users.

The location information may not be displayed correctly depending on the network status, the type of communication device or other reasons. You shall supply the necessary PC, mobile phone device, communication device, operating system, data connection and electronic power necessary for using the Service under your own responsibility and at your own expense.

We shall not be responsible for any disputes among the users which may arise out of, in connection with, or in relation to the Service.
...
**Routeal, L.L.C.** makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
...
IN NO EVENT WILL **Routeal, L.L.C.** BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO **Routeal, L.L.C.**. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
...
These Terms constitute the entire agreement between you and **Routeal, L.L.C.** regarding the use of the Service, superseding any prior agreements between you and **Routeal, L.L.C.** relating to your use of the Service.

## Feedback

Please let us know what you think of the Service, these Terms and, in general, **COCOGER**. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, **COCOGER**, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.

## Questions & Contact Information

Questions or comments about the Service may be directed to us at the email address **support@routeal.com**.
